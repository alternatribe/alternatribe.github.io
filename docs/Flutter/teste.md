...
??? info "Exemplo de Código: Botão Customizado em Flutter"
    Aqui está a estrutura de um componente de botão customizado. Você pode copiar o código abaixo para usar no seu projeto:
